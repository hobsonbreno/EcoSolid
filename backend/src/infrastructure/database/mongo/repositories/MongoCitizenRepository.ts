    ...
    await this.citizenModel
      .findOneAndUpdate(
        { _id: citizen.id },
        {
          ...
          facePhotoUrl: citizen.facePhotoUrl,
          totalPoints: citizen.totalPoints,
          level: citizen.level,
          createdAt: citizen.createdAt,
          credentialId: citizen.credentialId,
          credentialPublicKey: citizen.credentialPublicKey,
        },
